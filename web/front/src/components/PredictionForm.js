...
const PredictionForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setPredictionResult(response.data.prediction); // Adjusted for expected response format
  ...
  return (
    <div className="form-container">
      ...
      <div className="form-description">
        <p>
          This full-stack application helps predict student persistence in
          academic programs based on the following key metrics. Simply fill out
          the form below, and the app will use machine learning to provide a
          prediction.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="prediction-form">
        ...
        <div className="form-group">
          <label>Co-op:</label>
          <select name="coop" value={studentData.coop} onChange={handleChange}>
            <option value=""></option>
